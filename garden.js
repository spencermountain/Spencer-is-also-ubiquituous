...
return true;
	...
	//freebase type
var url= context.focusedWindow.document.location + ""; 
if(url.match('freebase.com/')){ 
var cat=url.replace(/^.*?freebase.com\/type\/schema/,'');
var cat=url.replace(/^.*?freebase.com\/view/,'');
var cat=cat.replace(/\?.*/,'');
var cat=cat.replace(/\/\-.*/,'');
var url='http://garden.freebaseapps.com/fromtype?type='+cat;   
pblock.innerHTML ='edit ' +cat;
return true;
}
